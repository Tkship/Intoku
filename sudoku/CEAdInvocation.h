 ...
 * @param streamAdHelper The CEStreamADHelper backing your UI collection that can translate index paths to their originals.
 *
 ...
 * @param arg2 The second argument to the selector.
 * @param indexPath The third argument to the selector.
 * @param streamAdHelper The MPStreamAdPlacer backing your UI collection that can translate index paths to their originals.
 *
 * @return The invocation with all the parameters passed into the method.
 */
+ (NSInvocation *) invokeForTarget:(id)target
