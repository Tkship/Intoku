...
- (void)setTimeout:(NSTimeInterval)timeout{
    _streamAdHelper.reqTimeout = timeout;
}
...
- (void) loadAdWithStartPosition:(int)startPosition endPosition:(int)endPosition {
    _enableAd = YES;
    [_streamAdHelper prerollWithStartPosition:startPosition endPosition:endPosition];
    [_tableView ce_reloadData];
    [self updateVisiblePositions];
}
...
- (void) setAutoRePlay:(BOOL)enableAutoRePlay {
    [_streamAdHelper setAutoReplay:enableAutoRePlay];
}
...
} /* ce_dequeueReusableCellWithIdentifier */
